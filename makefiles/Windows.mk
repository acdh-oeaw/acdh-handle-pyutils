...
lint: ## check style with flake8
	flake8 acdh_handle_pyutils tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source acdh_handle_pyutils -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\acdh_handle_pyutils.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs acdh_handle_pyutils
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
